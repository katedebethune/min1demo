...
// for each of the five canvases
               if(canvases.hasOwnProperty(key)) { // should not be necessary, but just in case
                              ...
                              canvases[key].width = overlay1.img_width;
                              //console.log(overlay1.img_width);
                              //canvases[key].height = 234;
                              canvases[key].height = overlay1.img_height;
                              //console.log(overlay1.img_height);
...
//image_obj.src = 'img/min1.png';
image_obj.src = overlay1.img_src;
